...
@section('jsheader')
    <meta  name="title" content="{{$nota->title}}" >
...
<section class="container-custom">
    <div class="sub-barra">
        <p class="px-3">Inicio > Tramite y Servicios > {{$subT}} > {{$nota->title}}</p>
    </div>
    <div class="pt-15 pb-60">
        <div class="row w-100 mx-auto">
            ...
            <div class="col-12 col-lg-9 px-4 px-lg-5">
                <div>
                    <h3 class="tp-section-title mb-20">{{$nota->title}}</h3>
                    <p class="bajada-nota">{{$nota->excerpt}}</p>
                    <img src="/storage/{{$nota->image}}" alt="">
                    <p class="pt-20">
                        {!! $nota->body !!}</p>
                    @if ($nota->file)
                        <?php
                ...
                <div class="d-flex justify-content-end pe-5 mb-5 pb-5">
                    <div class="container-share">
                        ...
                        <a href="#" onclick="window.open('https://www.facebook.com/sharer.php?u={{url()->current()}}','Compartir', 'toolbar=0, status=0, width=650, height=450');"><i class="fab fa-facebook"></i></a>
                            <a href="https://api.whatsapp.com/send?text={{$nota->title}}, {{url()->current()}}"><i class="fab fa-whatsapp"></i></a>
