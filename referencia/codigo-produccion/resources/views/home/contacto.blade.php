...
@section('content')
@section('meta')
    <meta  name=title content="¿ Tienes alguna duda o consulta sobre? tiendas digitales, publicaciones de productos y servicios " >
    <meta  name=description content="Tiendas en linea, vender en linea, ventas tucuman,  contactate con nostros y vende autos usados, autos en tucuman">
    <title>¿ Tienes alguna duda o consulta sobre? tiendas digitales, publicaciones de productos y servicios </title>
@stop
                ...
                <div class="container-fluid py-3 h-100 shadow rounded bg-white">
                    ...
                    <ul class="list-group list-group-flush ">
                        <li class="list-group-item d-flex flex-column flex-md-row justify-content-between">
                            ...
                            <span>(381) 505-2205</span>
                        </li>
                        <li class="list-group-item d-flex flex-column flex-md-row justify-content-between">
                            <b><i class="far fa-envelope"></i> E-mail</b>
                            <span>info@ventastucuman.com</span>
                        </li>
                        <li class="list-group-item d-flex flex-column flex-md-row justify-content-between">
                            <b><i class="fab fa-facebook-square"></i> Facebook</b>
                            <a href="https://www.facebook.com/ventastucuman93" target="_blank" class="link-blue">ventastucuman93</a>
                        </li>
                        <li class="list-group-item d-flex flex-column flex-md-row justify-content-between">
                            <b><i class="fab fa-twitter"></i> Twitter</b>
                            <a href="https://twitter.com/ventas_tucuman" target="_blank" class="link-lightblue">ventas_tucuman</a>
                        </li>
                        <li class="list-group-item d-flex flex-column flex-md-row justify-content-between">
                            <b><i class="fab fa-instagram"></i> Instagram</b>
                            <a href="https://www.instagram.com/ventastucuman.20" target="_blank" class="link-violet">ventastucuman.20</a>
                        </li>
                    </ul>
                </div>
            </div>
